...
use App\Http\Requests\SliderFormRequest as MainRequest;
...
class SliderController extends Controller
{
     ...
     */
    protected $pathViewName = 'admin.pages.slider.';
    ...
    {
        if(!Gate::allows('slider.change_status')){
            return redirect('/no-permission');
        }
        $id = $request->id;
    ...
    {
        if(!Gate::allows('slider.change_display')){
            return redirect('/no-permission');
        }
        $id = $request->id;
