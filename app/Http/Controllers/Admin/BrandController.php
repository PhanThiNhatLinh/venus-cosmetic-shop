...
use App\Http\Requests\BrandFormRequest as MainRequest;
...
class BrandController extends Controller
{
     ...
     */
    protected $pathViewName = 'admin.pages.brand.';
    protected $controllerName ='brand';
    protected $model;
    protected $params=[];
    ...
    {
        if(!Gate::allows('brand.change_status')){
            return redirect('/no-permission');
        }else{
            $id = $request->id;
    ...
    {
        if(!Gate::allows('brand.change_display')){
            return redirect('/no-permission');
        }else{
            $id = $request->id;
