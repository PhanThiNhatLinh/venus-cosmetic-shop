...
use App\Http\Requests\BlogFormRequest as MainRequest;
...
class BlogController extends Controller
{
     ...
     */
    protected $pathViewName = 'admin.pages.blog.';
    protected $controllerName ='blog';
    protected $model;
    protected $params=[];
    ...
    {
        if(!Gate::allows('blog.change_status')){
            return redirect('/no-permission');
        }else{
            $id = $request->id;
    ...
    {
        if(!Gate::allows('blog.change_display')){
            return redirect('/no-permission');
        }else{
            $id = $request->id;
