    ...
    <div class="row" >
      ...
      <div style="margin-bottom: 50px" class ="col-3">
        <div class="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3" bis_skin_checked="1">
          <div class="bg-primary mt-n5 py-3" style="width: 100px;" bis_skin_checked="1">
            {!!$xhtml!!}
          </div>
          <div class="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 200px; height: 200px;" bis_skin_checked="1">
